...
namespace QuickAzure
{
    public class AzureEnv
    {
        ...
        public AzureEnv(Dictionary<string, string> endpoints)
        {
            this.endpoints = endpoints;
        }

        #region known Environments
        public static AzureEnv Azure = new AzureEnv(new Dictionary<string, string>()
        {
        ...
        public static AzureEnv AzureChina = new AzureEnv(new Dictionary<string, string>()
        ...
        public static AzureEnv AzureUSGovernment = new AzureEnv(new Dictionary<string, string>()
        ...
        public static AzureEnv AzureGermany = new AzureEnv(new Dictionary<string, string>()
